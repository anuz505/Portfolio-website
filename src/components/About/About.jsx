            ...
            >
              <div className="description-card">
                <p className="description-text">
                  ...
                  covers to building neural networks, my work reflects both logic and emotion. 
                  I believe the best ideas come from collisions — between disciplines, perspectives, and possibilities.
                </p>
              </div>
            </ScrollFloat>
          </div>
